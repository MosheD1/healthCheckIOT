...
DHT_topic = 'healthCheck/person/id/status'
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        ...
        dict = {"bodyTemperature": str(bodyTemp), "pulseRate": str(pulseRate), "respirationRate": str(respirationRate), "bloodPressure": str(bloodPressure)}
